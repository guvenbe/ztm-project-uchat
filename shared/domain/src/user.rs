...
impl UserFacingError for UsernameError {
    fn formatted_error(&self) -> &'static str {
        match self {
            ...
            UsernameError::TooShort => "User name is too short. Must be at least Must be at least 3 characters",
...
impl UserFacingError for PasswordError {
    fn formatted_error(&self) -> &'static str {
        match self {
            ...
            PasswordError::TooShort => "Password is too short. Must be at least Must be at least 8 characters",
        }
    }
}
